const themeSlider = (elements) => {
  ...
  elementsSlide.forEach((element) => {
    ...
    if (slideCount > 1) {
      ...
      const loop = Boolean(element.getAttribute("data-loop")) ?? true ;
      const slidesPerView = element.getAttribute("slides-per-view") ?? 1;
...
themeSlider(".swiper.mega_menu-collections");
themeSlider(".swiper.annountcement-bar");
themeSlider(".swiper.mega-menu-images")
